...
def maximo_recursivo(*args) -> float:
    ...
    # Caso recursivo: comparar el primer elemento con el máximo del resto
    resto_maximo = maximo_recursivo(*args[1:])
    return args[0] if args[0] > resto_maximo else resto_maximo


# NO MODIFICAR - INICIOw
